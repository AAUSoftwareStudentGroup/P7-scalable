...
var author$project$Main$stepCreateUser = F2(
	function (model, _n0) {
		var createUser = _n0.a;
		var cmds = _n0.b;
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					page: author$project$Main$CreateUser(createUser)
				}),
	...
	function (model, _n0) {
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					page: author$project$Main$ListUsers(listUsers)
				}),
	...
	function (model, _n0) {
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					page: author$project$Main$Login(login)
				}),
	...
	function (model, _n0) {
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					page: author$project$Main$Messages(messages)
				}),
...
var author$project$GenHelpers$Other = {$: 'Other'};
						...
						return function (gender) {
							return function (birthday) {
								return function (town) {
									return function (profileText) {
										return {birthday: birthday, email: email, gender: gender, password: password, profileText: profileText, response: response, session: session, title: title, town: town, username: username};
									};
								};
							};
						};
...
var author$project$Page$CreateUser$init = function (session) {
	return _Utils_Tuple2(
		author$project$Page$CreateUser$Model(session)('')(elm$core$Maybe$Nothing)('')('')('')(author$project$GenHelpers$Other)('')('')(''),
		elm$core$Platform$Cmd$none);
};
var author$project$Page$ListUsers$Model = F3(
	function (session, title, users) {
		return {session: session, title: title, users: users};
	});
...
var author$project$GenHelpers$Female = {$: 'Female'};
var author$project$GenHelpers$Male = {$: 'Male'};
var elm$json$Json$Decode$fail = _Json_fail;
var elm$json$Json$Decode$succeed = _Json_succeed;
var author$project$GenHelpers$decodeGenderAux = function (str) {
	switch (str) {
		case 'Male':
			return elm$json$Json$Decode$succeed(author$project$GenHelpers$Male);
		case 'Female':
			return elm$json$Json$Decode$succeed(author$project$GenHelpers$Female);
		case 'Other':
			return elm$json$Json$Decode$succeed(author$project$GenHelpers$Other);
		default:
...
var author$project$GenHelpers$decodeGender = A2(
	elm$json$Json$Decode$andThen,
	author$project$GenHelpers$decodeGenderAux,
	A2(elm$json$Json$Decode$field, 'gender', elm$json$Json$Decode$string));
var author$project$Generated$DatingApi$User = F8(
	function (userEmail, userPassword, userUsername, userGender, userBirthday, userTown, userProfileText, userAuthToken) {
		return {userAuthToken: userAuthToken, userBirthday: userBirthday, userEmail: userEmail, userGender: userGender, userPassword: userPassword, userProfileText: userProfileText, userTown: userTown, userUsername: userUsername};
	});
var author$project$Generated$DatingApi$decodeUser = A3(
	...
	A3(
		...
		A3(
			...
			A3(
				...
				A2(
					NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$custom,
					author$project$GenHelpers$decodeGender,
					A3(
						NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
						'username',
						elm$json$Json$Decode$string,
						A3(
							...
							A3(
								...
								'email',
								elm$json$Json$Decode$string,
								elm$json$Json$Decode$succeed(author$project$Generated$DatingApi$User)))))))));
...
var author$project$Generated$DatingApi$getUsers = function (token) {
	return elm$http$Http$request(
		{
			body: elm$http$Http$emptyBody,
			expect: elm$http$Http$expectJson(
				elm$json$Json$Decode$list(author$project$Generated$DatingApi$decodeUser)),
			headers: _List_fromArray(
				[
					A2(elm$http$Http$header, 'Auth-Token', 'dating-auth-cookie=' + token)
				]),
			method: 'GET',
...
var author$project$Page$ListUsers$sendGetUsers = F2(
	function (responseMsg, data) {
		if (data.$ === 'LoggedIn') {
			...
			return A2(
				elm$http$Http$send,
				responseMsg,
				author$project$Generated$DatingApi$getUsers(token));
		} else {
			var navKey = data.a;
			return A2(
				elm$http$Http$send,
				responseMsg,
				author$project$Generated$DatingApi$getUsers(''));
		}
	});
var author$project$Page$ListUsers$init = function (session) {
	return _Utils_Tuple2(
		A3(author$project$Page$ListUsers$Model, session, 'List Users', _List_Nil),
		A2(author$project$Page$ListUsers$sendGetUsers, author$project$Page$ListUsers$UsersFetched, session));
};
var author$project$Page$Login$init = function (session) {
	return _Utils_Tuple2(
		{password: 'repsak', response: elm$core$Maybe$Nothing, session: session, title: 'Login', username: 'Bargsteen'},
		elm$core$Platform$Cmd$none);
};
var author$project$Page$Messages$Content = function (a) {
	return {$: 'Content', a: a};
};
var author$project$Page$Messages$Model = F3(
...
var author$project$Page$Messages$init = function (session) {
	return _Utils_Tuple2(
		A3(
			...
			A2(elm$core$Debug$log, 'messages session:', session),
			'Messages',
			author$project$Page$Messages$Content(
				_List_fromArray(
...
var author$project$Page$Profile$Model = F4(
	function (session, title, id, user) {
		return {id: id, session: session, title: title, user: user};
	});
var author$project$Page$Profile$authenticationToken = function (data) {
	if (data.$ === 'LoggedIn') {
		var navKey = data.a;
		var token = data.b;
		return token;
...
var author$project$Page$Profile$emptyUser = A8(author$project$Generated$DatingApi$User, '', '', '', author$project$GenHelpers$Other, '', '', '', '');
var elm$url$Url$percentEncode = _Url_percentEncode;
var author$project$Generated$DatingApi$getUsersByUserid = F2(
	function (userId, token) {
		return elm$http$Http$request(
			{
				body: elm$http$Http$emptyBody,
				expect: elm$http$Http$expectJson(author$project$Generated$DatingApi$decodeUser),
				headers: _List_fromArray(
					[
						A2(elm$http$Http$header, 'Auth-Token', 'dating-auth-cookie=' + token)
					]),
...
var author$project$Page$Profile$sendGetUser = F3(
	function (responseMsg, userId, token) {
		return A2(
			elm$http$Http$send,
			responseMsg,
			A2(author$project$Generated$DatingApi$getUsersByUserid, userId, token));
	});
var author$project$Page$Profile$init = F2(
	function (session, id) {
		return _Utils_Tuple2(
			A4(author$project$Page$Profile$Model, session, 'Profile', id, author$project$Page$Profile$emptyUser),
			A3(
				author$project$Page$Profile$sendGetUser,
				author$project$Page$Profile$HandleGetUser,
				id,
				author$project$Page$Profile$authenticationToken(session)));
	});
...
var author$project$Main$stepUrl = F2(
	function (url, model) {
		...
		var queryToPathUrl = _Utils_update(
			url,
			{
				path: A2(elm$core$Maybe$withDefault, '', url.query),
				...
				_List_fromArray(
					[
						...
						A2(
							...
							model,
							A2(author$project$Page$Profile$init, session, 10))),
						A2(
						author$project$Main$route,
		...
		var _n0 = A2(
			...
			parser,
			A2(elm$core$Debug$log, 'queryToPathUrl:', queryToPathUrl));
		if (_n0.$ === 'Just') {
			var answer = _n0.a;
			return answer;
		} else {
	...
	function (maybeToken, url, key) {
		var session = function () {
			if (maybeToken.$ === 'Nothing') {
				return author$project$Session$empty(key);
			} else {
				...
				return A2(
					...
					A2(
						...
						'',
						A2(elm$json$Json$Decode$decodeString, elm$json$Json$Decode$string, token)));
			}
		}();
		return A2(
...
var author$project$GenHelpers$encodeGender = function (g) {
	switch (g.$) {
		case 'Male':
...
var author$project$Generated$DatingApi$encodeUser = function (x) {
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'email',
				elm$json$Json$Encode$string(x.userEmail)),
				_Utils_Tuple2(
				'password',
				elm$json$Json$Encode$string(x.userPassword)),
				_Utils_Tuple2(
				'username',
				elm$json$Json$Encode$string(x.userUsername)),
				_Utils_Tuple2(
				'gender',
				author$project$GenHelpers$encodeGender(x.userGender)),
				_Utils_Tuple2(
				'birthday',
				elm$json$Json$Encode$string(x.userBirthday)),
				_Utils_Tuple2(
				'town',
				elm$json$Json$Encode$string(x.userTown)),
				_Utils_Tuple2(
				'profileText',
				elm$json$Json$Encode$string(x.userProfileText)),
				_Utils_Tuple2(
				'authToken',
				elm$json$Json$Encode$string(x.userAuthToken))
			]));
};
...
var author$project$Generated$DatingApi$postUsers = function (body) {
	return elm$http$Http$request(
		{
			body: elm$http$Http$jsonBody(
				author$project$Generated$DatingApi$encodeUser(body)),
...
var author$project$Page$CreateUser$createUserCmd = function (user) {
	return A2(
		elm$http$Http$send,
		author$project$Page$CreateUser$HandleUserCreated,
		author$project$Generated$DatingApi$postUsers(user));
};
var author$project$Page$CreateUser$mkUserFromEntries = function (_n0) {
	var email = _n0.email;
	...
	var town = _n0.town;
	var profileText = _n0.profileText;
	return A8(author$project$Generated$DatingApi$User, email, password, username, gender, birthday, town, profileText, 'token');
};
...
var author$project$Routing$routeToString = function (page) {
	...
	return '?path=/' + A2(elm$core$String$join, '/', pieces);
};
...
var author$project$Page$CreateUser$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'EntryChanged':
				var updatedModel = msg.a;
				return _Utils_Tuple2(updatedModel, elm$core$Platform$Cmd$none);
			case 'CreateUserClicked':
				return _Utils_Tuple2(
					model,
					author$project$Page$CreateUser$createUserCmd(
						author$project$Page$CreateUser$mkUserFromEntries(model)));
			default:
				var result = msg.a;
				if (result.$ === 'Ok') {
					var uid = result.a;
						...
						case 'BadUrl':
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										response: elm$core$Maybe$Just('Bad url: ' + url)
									}),
								elm$core$Platform$Cmd$none);
						case 'BadPayload':
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										response: elm$core$Maybe$Just('bad payload')
									}),
								elm$core$Platform$Cmd$none);
						case 'Timeout':
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										response: elm$core$Maybe$Just('timeout')
									}),
								elm$core$Platform$Cmd$none);
						case 'NetworkError':
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										response: elm$core$Maybe$Just('networkerror')
									}),
								elm$core$Platform$Cmd$none);
						default:
...
var author$project$Page$Login$handleErrorResponse = F2(
	function (model, errResponse) {
		switch (errResponse.$) {
			case 'BadUrl':
				var url = errResponse.a;
...
var author$project$Generated$DatingApi$Credentials = F2(
	function (username, password) {
		return {password: password, username: username};
	});
var author$project$Generated$DatingApi$encodeCredentials = function (x) {
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
...
var author$project$Generated$DatingApi$postLogin = function (body) {
	return elm$http$Http$request(
		{
			body: elm$http$Http$jsonBody(
				author$project$Generated$DatingApi$encodeCredentials(body)),
			expect: elm$http$Http$expectJson(elm$json$Json$Decode$string),
			headers: _List_Nil,
			method: 'POST',
			timeout: elm$core$Maybe$Nothing,
			url: A2(
				...
				'/',
				_List_fromArray(
					['http://api.dating.local:8002', 'login'])),
			withCredentials: false
		});
};
...
var author$project$Page$Login$loginCmd = F2(
	function (username, password) {
		return A2(
			elm$http$Http$send,
			author$project$Page$Login$HandleUserLogin,
			author$project$Generated$DatingApi$postLogin(
				A2(author$project$Generated$DatingApi$Credentials, username, password)));
	});
...
var author$project$Page$Login$storeCache = _Platform_outgoingPort(
	'storeCache',
	function ($) {
		return A3(elm$core$Maybe$destruct, elm$json$Json$Encode$null, elm$core$Basics$identity, $);
	});
var author$project$Page$Login$storeTokenInCache = function (token) {
	return author$project$Page$Login$storeCache(
		elm$core$Maybe$Just(
...
var author$project$Page$Login$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'TextChanged':
				var changedModel = msg.a;
				return _Utils_Tuple2(changedModel, elm$core$Platform$Cmd$none);
			case 'LoginClicked':
				return _Utils_Tuple2(
					model,
					A2(author$project$Page$Login$loginCmd, model.username, model.password));
			default:
				var result = msg.a;
				if (result.$ === 'Ok') {
					var token = result.a;
					return _Utils_Tuple2(
						...
						elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
									author$project$Page$Login$storeTokenInCache(token),
									A2(
									author$project$Routing$replaceUrl,
									author$project$Session$navKey(model.session),
					...
					var errResponse = result.a;
					return _Utils_Tuple2(
						A2(author$project$Page$Login$handleErrorResponse, model, errResponse),
						elm$core$Platform$Cmd$none);
				}
		}
	});
...
var author$project$Page$Profile$update = F2(
	function (msg, model) {
		...
		if (result.$ === 'Ok') {
			...
			return A2(
				elm$core$Debug$log,
				elm$core$Debug$toString(errResponse),
				_Utils_Tuple2(
					_Utils_update(
						model,
						{user: author$project$Page$Profile$emptyUser}),
					elm$core$Platform$Cmd$none));
		}
	});
	...
	function (message, model) {
		switch (message.$) {
			...
			case 'CreateUserMsg':
				...
				var _n2 = model.page;
				if (_n2.$ === 'CreateUser') {
					var createUser = _n2.a;
					return A2(
						author$project$Main$stepCreateUser,
						model,
						A2(author$project$Page$CreateUser$update, msg, createUser));
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
			case 'LoginMsg':
				...
				if (_n3.$ === 'Login') {
					...
					return A2(
						author$project$Main$stepLogin,
						model,
						A2(author$project$Page$Login$update, msg, login));
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
			case 'ListUsersMsg':
				...
				if (_n4.$ === 'ListUsers') {
					...
					return A2(
						author$project$Main$stepListUsers,
						model,
						A2(author$project$Page$ListUsers$update, msg, listUsers));
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
			case 'ProfileMsg':
				...
				if (_n5.$ === 'Profile') {
					...
					return A2(
						author$project$Main$stepProfile,
						model,
						A2(author$project$Page$Profile$update, msg, profile));
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
			default:
				...
				if (_n6.$ === 'Messages') {
					...
					return A2(
						author$project$Main$stepMessages,
						model,
						A2(author$project$Page$Messages$update, msg, messages));
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
		}
	});
var author$project$Page$CreateUser$CreateUserClicked = {$: 'CreateUserClicked'};
var author$project$Page$CreateUser$EntryChanged = function (a) {
	return {$: 'EntryChanged', a: a};
};
...
var author$project$Page$CreateUser$darkBlue = A3(mdgriffith$elm_ui$Element$rgb, 0, 0, 0.9);
var author$project$Page$CreateUser$red = A3(mdgriffith$elm_ui$Element$rgb, 0.8, 0, 0);
var author$project$Page$CreateUser$responseToString = function (r) {
	if (r.$ === 'Just') {
		var msg = r.a;
		return msg;
	} else {
...
var author$project$Page$CreateUser$mkWarning = function (warning) {
	return A2(
		mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				mdgriffith$elm_ui$Element$Font$color(author$project$Page$CreateUser$red),
...
var author$project$Page$CreateUser$showWarningIfUsernameIsTaken = function (username) {
	return (username === 'Bargsteen') ? author$project$Page$CreateUser$mkWarning('Username is taken') : mdgriffith$elm_ui$Element$none;
};
var author$project$Page$CreateUser$white = A3(mdgriffith$elm_ui$Element$rgb, 1, 1, 1);
...
var author$project$Page$CreateUser$viewContent = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					mdgriffith$elm_ui$Element$text('User creation')),
					A2(
						...
						]),
					{
						...
						onChange: function (_new) {
							return author$project$Page$CreateUser$EntryChanged(
								_Utils_update(
									model,
									{email: _new}));
						},
					...
					_List_fromArray(
						[
							...
							author$project$Page$CreateUser$showWarningIfUsernameIsTaken(model.username))
						]),
					{
						label: A2(
							mdgriffith$elm_ui$Element$Input$labelAbove,
						...
						]),
					{
						label: A2(
							...
							mdgriffith$elm_ui$Element$text('Gender')),
						onChange: function (_new) {
							return author$project$Page$CreateUser$EntryChanged(
								_Utils_update(
									model,
						...
						options: _List_fromArray(
							[
								A2(
								mdgriffith$elm_ui$Element$Input$option,
								author$project$GenHelpers$Male,
								mdgriffith$elm_ui$Element$text('Man')),
								A2(
								mdgriffith$elm_ui$Element$Input$option,
								author$project$GenHelpers$Female,
								mdgriffith$elm_ui$Element$text('Woman')),
								A2(
								mdgriffith$elm_ui$Element$Input$option,
								author$project$GenHelpers$Other,
								mdgriffith$elm_ui$Element$text('Other'))
							]),
						selected: elm$core$Maybe$Just(model.gender)
					}),
					A2(
						...
						]),
					{
						label: A2(
							...
							mdgriffith$elm_ui$Element$text('Birthday')),
						onChange: function (_new) {
							return author$project$Page$CreateUser$EntryChanged(
								_Utils_update(
									model,
						...
						]),
					{
						label: A2(
							...
							mdgriffith$elm_ui$Element$text('Town')),
						onChange: function (_new) {
							return author$project$Page$CreateUser$EntryChanged(
								_Utils_update(
									model,
						...
						]),
					{
						label: A2(
							...
							mdgriffith$elm_ui$Element$text('Describe yourself')),
						onChange: function (_new) {
							return author$project$Page$CreateUser$EntryChanged(
								_Utils_update(
									model,
						...
						placeholder: elm$core$Maybe$Just(
							A2(
								mdgriffith$elm_ui$Element$Input$placeholder,
								_List_Nil,
								mdgriffith$elm_ui$Element$text('I like big butts and I cannot lie.'))),
						spellcheck: false,
					...
					_List_fromArray(
						[
							mdgriffith$elm_ui$Element$Background$color(author$project$Page$CreateUser$red),
							mdgriffith$elm_ui$Element$Font$color(author$project$Page$CreateUser$white),
							mdgriffith$elm_ui$Element$Border$color(author$project$Page$CreateUser$darkBlue),
						...
						]),
					{
						...
						onPress: elm$core$Maybe$Just(author$project$Page$CreateUser$CreateUserClicked)
					}),
					mdgriffith$elm_ui$Element$text(
					author$project$Page$CreateUser$responseToString(model.response))
				]));
	});
var author$project$Page$CreateUser$view = function (model) {
	return {
		kids: _List_fromArray(
			[
				A2(author$project$Page$CreateUser$viewContent, model.title, model)
			]),
		title: model.title
	};
};
...
var author$project$Page$ListUsers$fonts = mdgriffith$elm_ui$Element$Font$family(
	_List_fromArray(
		[
			...
			mdgriffith$elm_ui$Element$Font$typeface('Oxygen-Sans'),
...
var author$project$Page$ListUsers$primaryColorL = A3(mdgriffith$elm_ui$Element$rgb255, 255, 255, 255);
var author$project$Page$ListUsers$secondaryColor = A3(mdgriffith$elm_ui$Element$rgb255, 96, 125, 139);
var author$project$Page$ListUsers$secondaryColorD = A3(mdgriffith$elm_ui$Element$rgb255, 52, 81, 94);
...
var author$project$Page$ListUsers$createButton = F3(
	function (attributes, url, caption) {
		return A2(
			mdgriffith$elm_ui$Element$link,
			_Utils_ap(
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Element$paddingXY, 35, 15),
						mdgriffith$elm_ui$Element$Background$color(author$project$Page$ListUsers$primaryColorL),
						mdgriffith$elm_ui$Element$Border$rounded(4),
						mdgriffith$elm_ui$Element$Border$width(1),
						mdgriffith$elm_ui$Element$Border$solid,
						author$project$Page$ListUsers$fonts,
						mdgriffith$elm_ui$Element$Font$size(14),
						mdgriffith$elm_ui$Element$Font$semiBold,
						mdgriffith$elm_ui$Element$Font$color(author$project$Page$ListUsers$secondaryColor),
						mdgriffith$elm_ui$Element$mouseOver(
						_List_fromArray(
							[
								mdgriffith$elm_ui$Element$Font$color(author$project$Page$ListUsers$secondaryColorD)
							]))
					]),
				attributes),
			{
				label: mdgriffith$elm_ui$Element$text(
					elm$core$String$toUpper(caption)),
				url: url
			});
	});
var author$project$Page$ListUsers$createButtonRight = F2(
	function (url, caption) {
		return A3(
			author$project$Page$ListUsers$createButton,
			_List_fromArray(
				[mdgriffith$elm_ui$Element$alignRight]),
			url,
			caption);
	});
var author$project$Page$ListUsers$createLink = F3(
	function (url, attributes, innerHtml) {
		return A2(
			mdgriffith$elm_ui$Element$link,
			attributes,
			{label: innerHtml, url: url});
	});
var author$project$Page$ListUsers$profileShadowA = {
	blur: 2.0,
	color: A4(mdgriffith$elm_ui$Element$rgba, 0, 0, 0, 0.14),
	offset: _Utils_Tuple2(0.0, 2.0),
	size: 0
};
var author$project$Page$ListUsers$profileShadowB = {
	blur: 1.0,
	color: A4(mdgriffith$elm_ui$Element$rgba, 0, 0, 0, 0.12),
	offset: _Utils_Tuple2(0.0, 3.0),
	size: -2
};
var author$project$Page$ListUsers$profileShadowC = {
	blur: 5.0,
...
var author$project$Page$ListUsers$profileShadow = _List_fromArray(
	[
		mdgriffith$elm_ui$Element$Border$shadow(author$project$Page$ListUsers$profileShadowA),
		mdgriffith$elm_ui$Element$Border$shadow(author$project$Page$ListUsers$profileShadowB),
		mdgriffith$elm_ui$Element$Border$shadow(author$project$Page$ListUsers$profileShadowC)
	]);
var author$project$Page$ListUsers$profileShadowHoverA = {
	blur: 17,
	color: A4(mdgriffith$elm_ui$Element$rgba, 0, 0, 0, 0.2),
	offset: _Utils_Tuple2(0.0, 8.0),
	size: 0
};
var author$project$Page$ListUsers$profileShadowHoverB = {
	blur: 20,
	color: A4(mdgriffith$elm_ui$Element$rgba, 0, 0, 0, 0.19),
	offset: _Utils_Tuple2(0.0, 6.0),
	size: 0
};
var author$project$Page$ListUsers$profileShadowHover = _List_fromArray(
	[
		mdgriffith$elm_ui$Element$Border$shadow(author$project$Page$ListUsers$profileShadowHoverA),
		mdgriffith$elm_ui$Element$Border$shadow(author$project$Page$ListUsers$profileShadowHoverB)
	]);
...
var author$project$Page$ListUsers$showUser = function (user) {
	return A3(
		author$project$Page$ListUsers$createLink,
		...
		elm$core$List$concat(
			_List_fromArray(
				[
					...
					[
						mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill),
						mdgriffith$elm_ui$Element$mouseOver(author$project$Page$ListUsers$profileShadowHover)
					]),
					author$project$Page$ListUsers$profileShadow
				])),
		A2(
			mdgriffith$elm_ui$Element$row,
			_List_fromArray(
			...
			_List_fromArray(
				[
					...
					mdgriffith$elm_ui$Element$text(
						elm_community$string_extra$String$Extra$toSentenceCase(user.userUsername))),
					A2(author$project$Page$ListUsers$createButtonRight, 'chat/' + user.userUsername, 'chat')
				])));
};
		...
		kids: _List_fromArray(
			[
				...
				A2(
					...
					A2(elm$core$List$map, author$project$Page$ListUsers$showUser, model.users)))
			]),
		title: 'All users'
	};
};
var author$project$Page$Login$LoginClicked = {$: 'LoginClicked'};
var author$project$Page$Login$TextChanged = function (a) {
	return {$: 'TextChanged', a: a};
};
var author$project$Page$Login$blue = A3(mdgriffith$elm_ui$Element$rgb, 0, 0, 0.8);
var author$project$Page$Login$darkBlue = A3(mdgriffith$elm_ui$Element$rgb, 0, 0, 0.9);
var author$project$Page$Login$red = A3(mdgriffith$elm_ui$Element$rgb, 0.8, 0, 0);
var author$project$Page$Login$responseToString = function (r) {
	if (r.$ === 'Just') {
		var msg = r.a;
		return msg;
	} else {
...
var author$project$Page$Login$white = A3(mdgriffith$elm_ui$Element$rgb, 1, 1, 1);
...
var author$project$Page$Login$viewContent = function (model) {
	return A2(
		mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
			...
			[
					...
					]),
				{
					label: A2(
						...
						mdgriffith$elm_ui$Element$text('Username')),
					onChange: function (_new) {
						return author$project$Page$Login$TextChanged(
							_Utils_update(
								model,
								{username: _new}));
					},
				...
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$Background$color(author$project$Page$Login$red),
						mdgriffith$elm_ui$Element$Font$color(author$project$Page$Login$white),
						mdgriffith$elm_ui$Element$Border$color(author$project$Page$Login$darkBlue),
						A2(mdgriffith$elm_ui$Element$paddingXY, 32, 16),
						mdgriffith$elm_ui$Element$Border$rounded(3),
						mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill)
					]),
				{
					...
					onPress: elm$core$Maybe$Just(author$project$Page$Login$LoginClicked)
				}),
				A2(
				mdgriffith$elm_ui$Element$link,
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$Font$color(author$project$Page$Login$blue)
					]),
				{
					label: mdgriffith$elm_ui$Element$text('Not yet a user? Click here to sign up.'),
					url: 'create-user'
				}),
				A2(
				mdgriffith$elm_ui$Element$el,
				_List_Nil,
				mdgriffith$elm_ui$Element$text(
					author$project$Page$Login$responseToString(model.response)))
			]));
};
var author$project$Page$Login$view = function (model) {
	return {
		kids: _List_fromArray(
			[
				author$project$Page$Login$viewContent(model)
			]),
		title: model.title
	};
};
var author$project$Page$Messages$blue = A3(mdgriffith$elm_ui$Element$rgb, 0.4, 0.4, 0.8);
var author$project$Page$Messages$toText = function (str) {
	return A2(
		mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
...
var author$project$Page$Messages$viewContent = F2(
	function (title, _n0) {
		var messages = _n0.a;
		return A2(
			mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
					...
					mdgriffith$elm_ui$Element$Background$color(author$project$Page$Messages$blue)
				]),
			_Utils_ap(
				A2(elm$core$List$map, author$project$Page$Messages$toText, messages),
				_Utils_ap(
					_List_fromArray(
						[
							A2(
							...
							_List_Nil,
							{
								label: author$project$Page$Messages$toText('To Create User'),
								url: author$project$Routing$routeToString(author$project$Routing$CreateUser)
							})
						]),
					_List_fromArray(
						[
							...
							_List_Nil,
							{
								label: author$project$Page$Messages$toText('To all users'),
								url: author$project$Routing$routeToString(author$project$Routing$ListUsers)
							})
						]))));
	});
var author$project$Page$Messages$view = function (model) {
	return {
		kids: _List_fromArray(
			[
				A2(author$project$Page$Messages$viewContent, model.title, model.content)
			]),
		title: model.title
	};
};
...
var author$project$Page$NotFound$toText = function (str) {
	return A2(
		mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
...
var author$project$Page$NotFound$viewContent = F2(
	function (title, _n0) {
		var message = _n0.a;
		return author$project$Page$NotFound$toText(message);
	});
var author$project$Page$NotFound$view = {
	kids: _List_fromArray(
		[
			A2(
			author$project$Page$NotFound$viewContent,
			'Not Found',
			author$project$Page$NotFound$Content('This page was not found.'))
		]),
	title: 'Not found!'
};
var author$project$Page$Profile$darkBlue = A3(mdgriffith$elm_ui$Element$rgb, 0, 0, 0.9);
var author$project$Page$Profile$genderToString = function (gender) {
	switch (gender.$) {
		case 'Male':
			return 'Male';
		case 'Female':
					...
					[
						...
						_List_fromArray(
							[
								...
								mdgriffith$elm_ui$Element$centerX,
								mdgriffith$elm_ui$Element$Font$size(36),
								mdgriffith$elm_ui$Element$Border$color(author$project$Page$Profile$darkBlue)
							]),
						mdgriffith$elm_ui$Element$text(model.user.userUsername + '\'s profile')),
						A2(
						mdgriffith$elm_ui$Element$el,
						_List_fromArray(
							[
						...
						mdgriffith$elm_ui$Element$text(model.user.userUsername)),
						A2(
						mdgriffith$elm_ui$Element$el,
						_List_fromArray(
							[
						...
						mdgriffith$elm_ui$Element$text(model.user.userEmail)),
						A2(
						mdgriffith$elm_ui$Element$el,
						_List_fromArray(
							[
						...
						mdgriffith$elm_ui$Element$text(
							author$project$Page$Profile$genderToString(model.user.userGender))),
						A2(
						mdgriffith$elm_ui$Element$el,
						_List_fromArray(
							[
						...
						mdgriffith$elm_ui$Element$text(model.user.userBirthday)),
						A2(
						mdgriffith$elm_ui$Element$el,
						_List_fromArray(
							[
						...
						mdgriffith$elm_ui$Element$text(model.user.userTown)),
						A2(
						...
						_List_fromArray(
							[
								mdgriffith$elm_ui$Element$text(model.user.userProfileText)
							]))
					]))
			]),
...
var author$project$Skeleton$red = A3(mdgriffith$elm_ui$Element$rgb255, 255, 105, 97);
var author$project$Skeleton$white = A3(mdgriffith$elm_ui$Element$rgb, 1, 1, 1);
...
var author$project$Skeleton$viewFooter = A2(
	...
	_List_fromArray(
		[
			...
			mdgriffith$elm_ui$Element$Font$color(author$project$Skeleton$white),
			mdgriffith$elm_ui$Element$alignBottom,
			mdgriffith$elm_ui$Element$Background$color(author$project$Skeleton$red)
		]),
	_List_fromArray(
		[
			A2(
			mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[mdgriffith$elm_ui$Element$Region$footer, mdgriffith$elm_ui$Element$centerX]),
			mdgriffith$elm_ui$Element$text('A Dating Service that Rocks! © 2018'))
		]));
...
var author$project$Skeleton$linkStyle = _List_fromArray(
	[
		mdgriffith$elm_ui$Element$Font$color(author$project$Skeleton$white),
...
var author$project$Skeleton$viewHeader = function (title) {
	return A2(
		mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				mdgriffith$elm_ui$Element$text('Dating')),
				A2(
				mdgriffith$elm_ui$Element$row,
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$alignRight,
						A2(mdgriffith$elm_ui$Element$spacingXY, 60, 20),
				...
				_List_fromArray(
					[
						A2(
						mdgriffith$elm_ui$Element$link,
						author$project$Skeleton$linkStyle,
						{
							label: mdgriffith$elm_ui$Element$text('Create User'),
							url: author$project$Routing$routeToString(author$project$Routing$CreateUser)
						}),
						A2(
						mdgriffith$elm_ui$Element$link,
						...
						{
							label: mdgriffith$elm_ui$Element$text('Login'),
							url: author$project$Routing$routeToString(author$project$Routing$Login)
						}),
						A2(
						mdgriffith$elm_ui$Element$link,
						author$project$Skeleton$linkStyle,
						{
							label: mdgriffith$elm_ui$Element$text('Messages'),
							url: author$project$Routing$routeToString(author$project$Routing$Messages)
						})
					]))
			]));
};
			...
			body: _List_fromArray(
				[
					...
					A2(
						...
						_List_fromArray(
							[
								author$project$Skeleton$viewHeader(details.title),
								A2(
								...
								A2(
									...
									_List_fromArray(
										[
											...
											mdgriffith$elm_ui$Element$Background$color(author$project$Skeleton$white)
										]),
									details.kids)),
...
var author$project$Main$view = function (model) {
	...
	switch (_n0.$) {
		case 'NotFound':
			return A2(author$project$Skeleton$view, elm$core$Basics$never, author$project$Page$NotFound$view);
		case 'CreateUser':
			var createUser = _n0.a;
			return A2(
				author$project$Skeleton$view,
				author$project$Main$CreateUserMsg,
				author$project$Page$CreateUser$view(createUser));
		case 'Login':
			var login = _n0.a;
			return A2(
				author$project$Skeleton$view,
		...
		case 'Messages':
			...
			return A2(
				...
				author$project$Page$Messages$view(unused));
		case 'ListUsers':
			var listUsers = _n0.a;
			return A2(
				author$project$Skeleton$view,
				author$project$Main$ListUsersMsg,
				author$project$Page$ListUsers$view(listUsers));
		default:
			var profile = _n0.a;
			return A2(
				author$project$Skeleton$view,
