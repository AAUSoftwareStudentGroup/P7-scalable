		...
		return A2(
			...
			url,
			{
				...
				page: author$project$Main$NotFound(
					author$project$Session$empty(key))
			});
	});
...
var author$project$Generated$DatingApi$User = F9(
	function (userEmail, userPassword, userUsername, userGender, userBirthday, userTown, userProfileText, userAuthToken, id) {
		return {id: id, userAuthToken: userAuthToken, userBirthday: userBirthday, userEmail: userEmail, userGender: userGender, userPassword: userPassword, userProfileText: userProfileText, userTown: userTown, userUsername: userUsername};
	});
var author$project$Page$CreateUser$mkUserFromEntries = function (_n0) {
	...
	return A9(author$project$Generated$DatingApi$User, email, password, username, gender, birthday, town, profileText, 'token', 10);
};
